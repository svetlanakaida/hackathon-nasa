...
function awaitTransaction(func, blocksToCheck, checkInterval) {
    if (blocksToCheck === void 0) { blocksToCheck = 10; }
    if (checkInterval === void 0) { checkInterval = 200; }
    return __awaiter(this, void 0, void 0, function () {
        var transaction, latestBlock, initialBlockNum;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    transaction = _a.sent();
                    return [4 /*yield*/, this.getHeadBlock()];
                case 2:
                    latestBlock = _a.sent();
                    initialBlockNum = latestBlock.block_num;
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var intConfirm = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.getHeadBlock()];
                                        case 1:
                                            latestBlock = _a.sent();
                                            if (hasTransaction(latestBlock, transaction.transaction_id)) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    info = _a.sent();
                    return [4 /*yield*/, this.eos.getBlock(info.head_block_num)];
                case 2:
                    block = _a.sent();
