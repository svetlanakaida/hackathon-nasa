        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    contract = _a.sent();
                    if (confirm) {
                        return [2 /*return*/, this.awaitTransaction(function () { return contract.licenseapi(creator, buyer, offerId, offerTemplate, overrideVoucherId, options); })];
                    }
